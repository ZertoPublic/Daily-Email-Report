...
################################################
$Username = "vCenter/ZVM User"
$Password = "Password"
$CSVDirectory = "Export Directory"
...
#------------------------------------------------------------------------------#
$EmailList1 = "user1@domain.com,user2@domain.com"
...
$vCenterArrayLine | Add-Member -MemberType NoteProperty -Name "SourcevCenter" -Value "SourcevCenterIP"
$vCenterArrayLine | Add-Member -MemberType NoteProperty -Name "SourceZVM" -Value "SourceZVMIP"
$vCenterArrayLine | Add-Member -MemberType NoteProperty -Name "TargetPOD" -Value "ZVRDRPOD1"
$vCenterArrayLine | Add-Member -MemberType NoteProperty -Name "TargetvCenter" -Value "TargetvCenterIP"
$vCenterArrayLine | Add-Member -MemberType NoteProperty -Name "TargetZVM" -Value "TargetZVMIP"
...
$SourceZVMSessionHeader_json = @{"Accept"="application/json"
"x-zerto-session"=$SourceZVMSession}

$SourceZVMSessionHeader_xml = @{"Accept"="application/xml"
"x-zerto-session"=$SourceZVMSession}
...
$TargetZVMSessionHeader_json = @{"Accept"="application/json"
"x-zerto-session"=$TargetZVMSession}
...
$TargetSiteInfoCMD = Invoke-RestMethod -Uri $TargetSiteInfoURL -TimeoutSec 100 -Headers $TargetZVMSessionHeader_json -ContentType $TypeJSON
...
$ResourceReport = Invoke-RestMethod -Uri $ResourceReportURL -TimeoutSec 100 -Headers $TargetZVMSessionHeader_json -ContentType $TypeJSON
#------------------------------------------------------------------------------#
...
$TargetZVMHostsCMD = Invoke-RestMethod -Uri $TargetZVMHostsURL -TimeoutSec 100 -Headers $TargetZVMSessionHeader_json -ContentType $TypeJSON
$TargetZVMVRAsURL = $TargetZVMBaseURL+"vras"
$TargetZVMVRAsCMD = Invoke-RestMethod -Uri $TargetZVMVRAsURL -TimeoutSec 100 -Headers $TargetZVMSessionHeader_json -ContentType $TypeJSON
...
$TargetDatastoresCMD = Invoke-RestMethod -Uri $TargetDatastoresURL -TimeoutSec 100 -Headers $TargetZVMSessionHeader_json -ContentType $TypeJSON
# For each datastore
...
$vpgList = Invoke-RestMethod -Uri $vpgListApiUrl -TimeoutSec 100 -Headers $SourceZVMSessionHeader_json -ContentType $TypeXML
# Build List of VMs
$vmListApiUrl = $SourceZVMBaseURL+"vms"
$vmList = Invoke-RestMethod -Uri $vmListApiUrl -TimeoutSec 100 -Headers $SourceZVMSessionHeader_json -ContentType $TypeXML
